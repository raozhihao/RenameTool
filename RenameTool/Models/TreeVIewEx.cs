...
namespace RenameTool.Models
{
    ...
    public class TreeViewEx : TreeView
    {
        ...
        {
            IntPtr tp = this.Handle;
            bool re = m.HWnd.Equals(this.Handle);
            if (re && m.Msg == 0x0203)
            {
                //拦截双击事件
                return;
        ...
        private Color selectedFillColor= Color.FromArgb(150, Color.Black);

        /// <summary>
        /// 在鼠标到达/选中节点时的填充颜色
        /// </summary>
        [Category("自定义外观"),Browsable(true)]
        ...
        private Color selectNoFocusedFillColor= Color.FromArgb(150, Color.Black);
        /// <summary>
        /// 当节点未有焦点但被选中时的填充色
        /// </summary>
        [Category("自定义外观"),Browsable(true)]
        public Color SelectNoFocusedFillColor
        {
            get { return selectNoFocusedFillColor; }
            set { selectNoFocusedFillColor = value; }
        }

        private Color noSelectedHovedFillColor= Color.FromArgb(150, Color.Black);
        /// <summary>
        /// 鼠标在节点上滑过时的填充色
        /// </summary>
        [Category("自定义外观"),Browsable(true)]
        public Color NoSelectedHovedFillColor
        {
            get { return noSelectedHovedFillColor; }
            set { noSelectedHovedFillColor = value; }
        }
        ...
        private void treeView1_DrawNode(object sender, DrawTreeNodeEventArgs e)
        {
            ...
            #region 1     选中的节点背景=========================================
            /*1节点被选中 ,TreeView有焦点*/
            SolidBrush brush1 = new SolidBrush(selectedFillColor);//new SolidBrush(Color.FromArgb(209, 232, 255));//填充颜色
            Pen pen1 = new Pen(Color.FromArgb(102, 167, 232), 1);//边框颜色


            /*2节点被选中 ,TreeView没有焦点*/
            SolidBrush brush2 = new SolidBrush(selectNoFocusedFillColor); //new SolidBrush(Color.FromArgb(247, 247, 247));//暂时未用
            Pen pen2 = new Pen(Color.FromArgb(222, 222, 222), 1);


            /*3 MouseMove的时候 画光标所在的节点的背景*/
            SolidBrush brush3 = new SolidBrush(noSelectedHovedFillColor); //new SolidBrush(Color.FromArgb(229, 243, 251));
            Pen pen3 = new Pen(Color.FromArgb(112, 192, 231), 1);
            ...
            #region 2     +-号绘制=========================================
            if (this.arrowImageList.Images.Count > 0)
            {
            ...
            {
                //图标大小16*16
                Rectangle imagebox = new Rectangle(e.Node.Bounds.X - 3 - 16,e.Node.Bounds.Y + 3,
